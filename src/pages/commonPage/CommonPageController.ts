...
export default class CommonPageController {
  ...
  public async createChat() {
    ...
    if (el.value != '') {
      try {
        ...
        const answer = xhrResponse as UserResponse;
  ...
  public static clearInputDeleteUserFromChat() {
    const inputDeleteUserFromChat = document.getElementById(
      'chooseUserForDelete',
    ) as HTMLInputElement;

    if (inputDeleteUserFromChat) {
      inputDeleteUserFromChat.value = '';
    }
  }
  ...
  public async getChatUsers() {
    ...
    if (
      ...
      (commonPage as CommonPage).getChatUsers(answer);
    }
  }
}
