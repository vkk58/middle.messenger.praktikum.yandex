...
export default class RegistrationPage extends Block{
    constructor() {
        ...
        let validatePage = new ValidateRegistrationPage();
        ...
        super(
            {
                ...
                CommonButton: new Button({text: "Создать профиль", id: 'createProfile', class: 'button', type: 'submit',currentPage: 'registrationPage',                                         
                                        events: {
                                            click: () => {
